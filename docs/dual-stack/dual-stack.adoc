...
link:https://kubernetes.io/docs/concepts/services-networking/dual-stack/[v1.23], allowing clusters to handle both
...
feature in version 1.17, and promoted it to link:https://istio.io/latest/news/releases/1.24.x/announcing-1.24/change-notes/[Alpha] in
...
For more details, you can refer to the Kubernetes link:https://kubernetes.io/docs/concepts/services-networking/dual-stack/#services[documentation].
...
Note: If you installed the KinD cluster using the command above, install the link:../../docs/general/getting-started.md#getting-started[Sail Operator] before proceeding with the next steps.
